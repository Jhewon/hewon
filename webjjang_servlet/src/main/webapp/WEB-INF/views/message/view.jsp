	...
	<div class="card">
		<div class="card-header">
			<div class="media border p-3">
				<img src="${vo.senderPhoto }"class="mr-3 mt-3 rounded-circle" style="width:60px; margin-top: 8px;">
...
<h3>보낸 메세지 보기</h3>
	<div class="card">
		<div class="card-header">
			<div class="media border p-3">
				<img src="${vo.accepterPhoto }"class="mr-3 mt-3 rounded-circle" style="width:60px; margin-top: 8px;">
				<div class="media-body">
