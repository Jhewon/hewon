	...
	public String execute(HttpServletRequest request) {
		...
		try { // 정상 처리
			...
			case "/message/write.do":
				...
				session.setAttribute("msg", "["+accepterId+"] 님에게 전송되었습니다. ");
				break;
